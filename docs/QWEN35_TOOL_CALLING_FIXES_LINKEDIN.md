...
**Summary**: Everyone's talking about Qwen 3.5's reasoning quality and slow TTFT, but few have discussed the tool calling issues that actually break agentic workflows. Here's what I encountered and how I fixed it after weeks of debugging.

---

## The Story So Far

I've been running Qwen 3.5-27B on a mixed GPU setup (RTX 4090 + 3090) for about a month now. The reasoning capabilities are genuinely impressive, and yes, the TTFT is slow, but honestly? **The tool calling issues are what actually matter if you're doing agentic work.**
...
#LLM #vLLM #Qwen3.5 #MLEngineering #AgenticAI #LocalLLaMA #AIEngineering #LLMOps
